...
public class Account {
	...
	public List<String> botAccess = new ArrayList<String>();
	public List<String> serverAccess = new ArrayList<String>();
	...
	public boolean hasBotAccess(String bot) {
		if (botAccess == null)
			botAccess = new ArrayList<String>();
		if (bot == null)
			return true;
		if (this.hasPerm("ignorebotaccess"))
			return true;
	...
	public boolean hasServerAccess(String bot, String server) {
		if (serverAccess == null)
			serverAccess = new ArrayList<String>();
		if (server == null)
			return true;
		if (this.hasPerm("ignoreserveraccess"))
			return true;
		for (String s : serverAccess) {
			if (s.equals(bot + "_" + server))
				return true;
		}
		return false;
	}
	...
	public void removeBotAccess(String bot) {
		if (botAccess.contains(bot))
			botAccess.remove(bot);
	}
	...
	public void removeServerAccess(String server) {
		if (serverAccess.contains(server))
			serverAccess.remove(server);
	}
